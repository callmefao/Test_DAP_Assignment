...
stream = CamGear(source='https://www.youtube.com/watch?v=6dp-bvQ7RWo', stream_mode=True, logging=True).start()
...
def gen_frames():
    ...
    while True:
        ...
        cv2.line(frame, (100, 180), (200, 130), (255, 255, 255), 1)
        cv2.line(frame, (120, 400), (80, 320), (255, 255, 255), 1)
        cv2.line(frame, (650, 130), (540,205), (255, 255, 255), 1)
        cv2.line(frame, (445, 90), (515, 90), (255, 255, 255), 1)
